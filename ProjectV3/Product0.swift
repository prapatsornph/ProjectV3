...
//  Shop
//
//  Created by Benz on 19/4/2561 BE.
...
class Product0: UIViewController, UITextFieldDelegate, UITextViewDelegate, UINavigationControllerDelegate{
    ...
    var textLabel: UILabel = {
        ...
        label.lineBreakMode = .byWordWrapping
        label.numberOfLines = 0
        label.text = "      DAVID JONES From Paris Genuine Leather Mini, One sewed top short handle, Adjustable double padded shoulder straps, Interior floral print polyester lining, Two interior pockets, One zipper big pocket at the front, Two small pocket at the back"
