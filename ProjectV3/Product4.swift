...
class Product4: UIViewController, UITextFieldDelegate, UITextViewDelegate, UINavigationControllerDelegate{
    ...
    var titleLabel: UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "Long Sleeve Shirt For Men"
    ...
    var textLabel: UILabel = {
        ...
        label.lineBreakMode = .byWordWrapping
        label.numberOfLines = 0
        label.text = "      Did you ever seen such colorful 3D paint splashed printed shirt? Do you want to be more attractive and fashionable in the street? Our exquisite shirt which is designed with mixed color, turndown collar, long sleeve and smooth car line can meet your needs."
