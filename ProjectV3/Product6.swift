...
//  Shop
//
//  Created by Benz on 23/4/2561 BE.
//  Copyright © 2561 Benz. All rights reserved.
//
import UIKit


class Product6: UIViewController, UITextFieldDelegate, UITextViewDelegate, UINavigationControllerDelegate{
    ...
    var textLabel: UILabel = {
        ...
        label.lineBreakMode = .byWordWrapping
        label.numberOfLines = 0
        label.text = "      นาฬิการุ่นนี้นำเสนอดีไซน์ G-SHOCK ที่มีความทนทานและแข็งแกร่งในตัวเรือน G-SHOCK สีดำสุดคลาสสิค สายผ้าร่มแบบใหม่ CORDURA®* nylon fabric นอกจากตัวสายแล้วแม้แต่ปุ่มของนาฬิกาก็เป็นสีดำรมควันสวยงาม รุ่น DW-6900BBN  มาพร้อมกับหน้าปัดดิจิตอลที่เปล่งแสงออกมาในที่มืดซึ่งมีสีเข้ากับสีของตัวเรือน"
