...
class Product1: UIViewController, UITextFieldDelegate, UITextViewDelegate, UINavigationControllerDelegate{
    ...
    let productImageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "inear")
    ...
    var titleLabel: UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "JBL Inear with Mic. T110 Black"
    ...
    var textLabel: UILabel = {
        ...
        label.lineBreakMode = .byWordWrapping
        label.numberOfLines = 0
        label.text = "      JBL T110 หูฟังแบบ In-Ear ที่ออกแบบให้มีขนาดเล็กกะทัดรัด น้ำหนักเบา สวมใส่บาย ใช้วัสดุที่ให้ความคงทนสูง ใช้ไดรฟ์เวอร์ ขนาด 9mm ต่อข้าง ขับเสียงเบสได้อย่างหนักแน่น ผนวกกับเทคโนโลยี JBL Pure Bass ที่จะมอบประสบการณ์การฟังเพลง เปรียบเสมือนกับนั่งฟังอยู่ในเวที Concert หรือห้องบันทึกเสียงชั้นนำของโลก"
