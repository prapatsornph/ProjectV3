...
class Product5: UIViewController, UITextFieldDelegate, UITextViewDelegate, UINavigationControllerDelegate{
    ...
    var titleLabel: UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "ADIDAS Coneo QT VS Paris Grey Glow Pink"
    ...
    var textLabel: UILabel = {
        ...
        label.lineBreakMode = .byWordWrapping
        label.numberOfLines = 0
        label.text = "      สำหรับผู้สวมใส่ลำลองเล่นกีฬา, สินค้าลิขสิทธิ์แท้จาก Adidas, สินค้าใช้วัสดุคุณภาพดี มีความทนทานสูง, สามารถใส่ได้ทุกเพศทุกวัย ตั้งแต่อายุ 8 ปีขึ้นไป, ได้รับการรับรองมาตรฐานการผลิตระดับโลก"
