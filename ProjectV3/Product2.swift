...
class Product2: UIViewController, UITextFieldDelegate, UITextViewDelegate, UINavigationControllerDelegate{
    ...
    var titleLabel: UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "Vera Wang Bouquet EDP 100 ml."
    ...
    var textLabel: UILabel = {
        ...
        label.lineBreakMode = .byWordWrapping
        label.numberOfLines = 0
        label.text = "      Fresh, fragrant, gentle fragrance, as if you are in the floral, to reconcile the elegant rose buds and Italian jasmine fragrance theme of the fragrance, showing a more light sexy temperament."
